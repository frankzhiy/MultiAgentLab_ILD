"""Internal item-level context passed into the Evidence Graph Structurer modules.

A plain immutable dataclass — its only job is to bundle one
StructuredClinicalItem together with its joined source_text and section
