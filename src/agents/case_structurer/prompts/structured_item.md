...
Do not diagnose, reason over differentials, or recommend treatment.
...
- label="间断咳嗽咳痰伴胸闷气短8年"; item_type="{{ example_primary_item_type_value }}"; temporality="{{ example_duration_temporality_value }}"; time_text="8年"; source_spans[0].quoted_text="间断咳嗽咳痰伴胸闷气短8年"
- label="加重2月"; item_type="{{ example_primary_item_type_value }}"; temporality="{{ example_change_temporality_value }}"; time_text="2月"; source_spans[0].quoted_text="加重2月"

Source section text:
"气道总阻力R5、外周阻力R5-R20及近端阻力R35增高"

Good structured item, preserving the coordinated source statement:
- label="气道总阻力R5、外周阻力R5-R20及近端阻力R35增高"; value=null; item_type="{{ example_primary_item_type_value }}"; source_spans[0].quoted_text="气道总阻力R5、外周阻力R5-R20及近端阻力R35增高"
