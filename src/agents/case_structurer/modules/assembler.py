...
class CaseStructuringAssembler:
    ...
    def assemble(
        ...
        ready_for_attribute_extraction = bool(sections or items)

        if not ready_for_attribute_extraction:
            warnings.append(
                StructuringWarning(
        ...
        return CaseStructuringResult(
            ...
            ready_for_attribute_extraction=ready_for_attribute_extraction,
        )
